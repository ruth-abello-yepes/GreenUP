...
INSERT INTO punto_reciclaje (nombre, direccion, id_estado)
VALUES ('Punto Reciclaje Centro', 'Calle 123 #45-67', 1),
    ('Punto Reciclaje Norte', 'Avenida 456 #78-90', 1);
INSERT INTO tipo_residuo (descripcion, id_estado)
VALUES ('Plástico', 1),
    ('Papel', 1),
    ('Vidrio', 1);
...
VALUES (1, 1, 1, 5.0, '2024-06-01'),
    (1, 2, 2, 3.0, '2024-06-02');
INSERT INTO recompensa (descripcion, puntos_recompensa, id_estado)
VALUES ('Descuento en tienda', 100, 1),
    ('Entrada a evento', 200, 1);
INSERT INTO canje (id_usuario, id_recompensa, fecha_canje)
